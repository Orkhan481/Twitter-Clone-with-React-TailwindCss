      ...
      <NavLink to={"/"} className="group block ">
        {({ isActive }) => (
          ...
          >
            ...
            <span className="text-bold mr-4 ml-5">Home</span>
          </div>
        )}
      </NavLink>
      ...
      <NavLink to={"/explore"} className="group block ">
        {({ isActive }) => (
          ...
          >
            ...
            <span className="text-bold mr-4 ml-5">Explore</span>
          </div>
        )}
      </NavLink>
      ...
      <NavLink to={"/notifications"} className="group block ">
        {({ isActive }) => (
          ...
          >
            ...
            <span className="text-bold mr-4 ml-5">Notifications</span>
          </div>
        )}
      </NavLink>
      {/* Messages Button*/}
      <NavLink to={"/messages"} className="group block ">
        {({ isActive }) => (
          <div
            className={classNames(
              "inline-flex p-3 group hover:bg-[#eff3f41a] transition-[2s] items-center rounded-full text-xl",
          ...
          >
            ...
            {isActive && (
              <svg
              viewBox="0 0 24 24" width={26} height={26} fill="#e7e9ea"
              >
                <g>
            ...
            <span className="text-bold mr-4 ml-5">Messages</span>
          </div>
        )}
      </NavLink>
    </nav>
